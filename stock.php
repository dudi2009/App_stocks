<h1 class="my-4 text-center">Stock bitzz <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-amazon" viewBox="0 0 16 16">
    ...
    <form action="" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12"> <label for="address" class="form-label">Price</label> <input type="number" name="harga" class="form-control" id="address" placeholder="Price" required="" fdprocessedid="350b4h">
                                <div class="invalid-feedback">
                                    Enter the price
                                </div>
                            </div>
                            <div class="col-12"> <label for="address" class="form-label">Stocks</label> <input type="number" name="stock" class="form-control" id="address" placeholder="...." required="" fdprocessedid="350b4h">
                                <div class="invalid-feedback">
                                    enter the stocks
                                </div>
                            </div>
       ...
       <?php
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO produk (id_produk, nama_produk, harga, stok)
